...
class SigmaCamera : public CameraPTP
{
    public:
        ...
        CamCaptStatus wait_completion(std::uint8_t image_id,
                                      int polls = 30, int sleep_ms = 1000);
        ...
        BigPartialPictFile get_big_partial_pict_file(std::uint32_t address, std::uint32_t max_bytes);
